...
<div class="page-container">
	...
	<div class="page-sidebar">
		...
		<header class="site-header">
		  <div class="site-logo"><a href="index.html"><img src="<?php echo base_url(); ?>assets/images/logo2.png" alt="Mouldifi" title="Mouldifi"></a></div>
...
?>
		<div class="col-md-12 animatedParent animateOnce "> 
			...
			<footer class="animatedParent animateOnce z-index-10"> 
				<div class="footer-main animated fadeInUp slow">&copy; 2017 <strong>GMF AeroAsia</strong>   </div>
			</footer>	
			<!-- /footer -->
