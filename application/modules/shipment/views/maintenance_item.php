<?php $timestamp = time();?>
<div id="info-maintenance-detail-<?php echo $timestamp; ?>"></div>
...
$(document).ready(function(){
	var ds_rpt_detail = new kendo.data.DataSource({
			transport: {
				read: {
					...
					url: '<?php echo site_url('shipment/shipment_item'); ?>',
				}
			},
			schema: {
	...
	$('#info-maintenance-detail-<?php echo $timestamp; ?>').kendoGrid({
		...
		columns: [
			...
			{field:'type',title:"Request Type", width:50,filterable: false},
