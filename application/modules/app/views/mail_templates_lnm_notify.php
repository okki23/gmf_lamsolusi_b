<?php
	$isi='Dear ALL <br><br> Berikut ini adalah informasi request yang telah terjadi di sistem Logistik GMF dan membutuhkan bantuan anda untuk melengkapi informasi harga :<br><br>';
